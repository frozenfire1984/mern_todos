	...
	return (
		<div className={`
			...
			<div className="todo__controls">
				<button onClick={() => props.put(props.item._id, props.index, "completed")}
								type="button"
								className="btn btn-flat todo__btn todo__btn_complete">
				...
				<button onClick={() => props.put(props.item._id, props.index, "important")}
								type="button"
								className="btn btn-flat todo__btn todo__btn_mark">
					{props.item.important
						? <BsExclamationDiamondFill/>
						: <BsExclamationDiamond/>
					}
				</button>
				<button onClick={() => props.remove(props.item._id, props.index)}
								type="button"
								className="btn btn-flat todo__btn todo__btn_delete">
					<ImCross/>
				</button>
			</div>
		</div>
